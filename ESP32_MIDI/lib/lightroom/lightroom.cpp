...
std::map<Menu, std::map<subMenu_t, std::map<id_t, value_t>>> Lightroom::_buttonsValues = {
	{None,
	 {{1,
	   {{0, DEFAULT_VALUE}}}}},
...
std::map<Menu, std::map<subMenu_t, std::map<id_t, value_t>>> Lightroom::_knobsValues = {
	{None,
	 {{1,
	   {{0, DEFAULT_VALUE}}}}},
